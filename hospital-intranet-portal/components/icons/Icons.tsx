...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.5 1.5 0 01-4.242 0l-3.72 3.72C3.847 17.1 3 16.136 3 15v-4.286c0-.97.616-1.813 1.5-2.097m14.25-3.364c.884-.284 1.5-1.128 1.5-2.097V4.286c0-1.136-.847-2.1-1.98-2.193l-3.72 3.72a1.5 1.5 0 01-4.242 0l-3.72-3.72C3.847 2.1 3 3.136 3 4.286v4.286c0 .97.616 1.813 1.5 2.097" />
  </svg>
);
...
export const UserGroupIcon: React.FC<{ className?: string }> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.083 1.53.083 2.257 0 4.243-.803 5.758-2.122M15 12a3 3 0 11-6 0 3 3 0 016 0zM6 18.719a9.075 9.075 0 012.741-.479 3 3 0 014.682-2.72M6 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);

export const HospitalIcon: React.FC<{ className?: string }> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5c.621 0 1.125-.504 1.125-1.125V6.828a2.25 2.25 0 00-.659-1.591L18.409 3.59a2.25 2.25 0 00-1.591-.659H7.182a2.25 2.25 0 00-1.591.659L3.841 5.237A2.25 2.25 0 003.182 6.828V19.875A1.125 1.125 0 003.75 21z" />
    </svg>
);
...
// FIX: Added missing ChevronLeftIcon component.
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226.554-.223 1.197-.23 1.762-.012a9.738 9.738 0 015.86 5.86c.218.565.21 1.208-.012 1.762-.224.55-.684 1.02-1.226 1.11a9.723 9.723 0 01-5.86 5.86c-.565.218-1.208.21-1.762-.012a9.738 9.738 0 01-5.86-5.86c-.218-.565-.21-1.208.012-1.762.224-.55.684-1.02 1.226-1.11a9.723 9.723 0 015.86-5.86zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
  </svg>
);
...
export const CommitteeIcon: React.FC<{ className?: string }> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h.008v.015h-.008v-.015zm17.242 0h.008v.015h-.008v-.015zM9.75 15.75h4.5m-4.5 0a.75.75 0 01.75-.75h3a.75.75 0 01.75.75m-4.5 0v2.25m4.5 0v2.25m-4.5 0a3.375 3.375 0 01-3.375-3.375V7.5a3.375 3.375 0 013.375-3.375h4.5a3.375 3.375 0 013.375 3.375v4.875c0 1.869-1.506 3.375-3.375 3.375h-4.5z" />
    </svg>
);
...
export const JournalIcon: React.FC<{ className?: string }> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
